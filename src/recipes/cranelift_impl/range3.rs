...
pub fn s_i64(from: i64, to: i64, step: i64) -> (u64,u64) {
...
fn f_i64<'f>(frefs: &HashMap<String,FuncRef>, ctx: &mut FunctionBuilder<'f>, val: &[Value]) -> Value {
   ...
   let fref = frefs.get("range:(I64,I64,I64)->I64[]").unwrap();
...
pub fn import() -> Vec<FFI> {vec![
   FFI {
      ...
      arg_types: vec![Type::nominal("I64"),Type::nominal("I64"),Type::nominal("I64")],
      name: "range:(I64,I64,I64)->I64[]".to_string(),
      cons: f_i64,
